...
import com.ricardotravez.cliente.proyecto.databinding.ActivityInicioBinding;
...
public class InicioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_inicio, R.id.nav_mis_compras, R.id.nav_ubicacion, R.id.nav_configuracion)
    ...
    private void loadData() {
        ...
        if(usuarioJson != null){
            ...
            String url = ConfigApi.ipRicardo + "/api/documento-almacenado/download/" + u.getCliente().getFoto().getFileName();
