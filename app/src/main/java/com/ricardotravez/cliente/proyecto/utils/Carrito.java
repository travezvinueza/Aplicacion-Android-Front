package com.ricardotravez.cliente.proyecto.utils;
...
public class Carrito {
    ...
    public static String agregarPlatillos(DetallePedido detallePedido) {
        ...
        for (DetallePedido dp : detallePedidos) {
            if (dp.getPlatillo().getId() == detallePedido.getPlatillo().getId()) {
                ...
                b = true;
                return "El accesorio ha sido agregado al carrito, se actualizará la cantidad";
            }
            index++;
        }
        if (!b) {
            detallePedidos.add(detallePedido);
            return "El accesorio ha sido agregado al carrito con éxito";
        }
        return ". . . . ";
    }
    ...
    public static void eliminar(final int idp) {
        ...
        if (dpE != null) {
            ...
            System.out.println("Se elimino el accesorio del detalle de pedido");
        }
    }
