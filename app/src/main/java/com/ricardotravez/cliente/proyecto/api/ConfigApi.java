...
public class ConfigApi {
    public static final String baseUrlE = "http://10.0.2.2:9093";
    public static final String ipRicardo = "https://travezvinueza-movil-backend.onrender.com/";
    ...
    private static void initClient() {
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(ipRicardo)//Si quieren ejecutar la app desde su móvil, cambiar aquí con la ip de su ordenador
